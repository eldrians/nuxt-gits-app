<template>
  <div class="w-full flex flex-col justify-center items-center">
    ...
    <a href="mailto:eldrianaxel1@gmail.com">
      <button class="py-2 px-4 bg-black mb-20 rounded shadow-xl transform duration-500 hover:scale-125" >
        <IconEmail class="text-slate-100"/>
      </button>
    </a>
  </div>
</template>